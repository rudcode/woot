...
class AgentBotsActions:
    list: Action = field(
        default_factory=Action(method="GET", url="platform/api/v1/agent_bots"),
    )
    create: Action = field(
        default_factory=Action(
            method="POST",
    ...
    get: Action = field(
        default_factory=Action(method="GET", url="platform/api/v1/agent_bots/{id}"),
    )
    update: Action = field(
        default_factory=Action(
            method="PATCH",
    ...
    delete: Action = field(
        default_factory=Action(method="DELETE", url="platform/api/v1/agent_bots/{id}"),
    )
...
class UsersActions:
    list: Action = field(
        default_factory=Action(method="GET", url="platform/api/v1/users"),
    )
    create: Action = field(
        default_factory=Action(
            method="POST",
    ...
    get: Action = field(
        default_factory=Action(method="GET", url="platform/api/v1/users/{id}"),
    )
    update: Action = field(
        default_factory=Action(
            method="PATCH",
    ...
    delete: Action = field(
        default_factory=Action(method="DELETE", url="platform/api/v1/users/{id}"),
    )
    get_sso_link: Action = field(
        default_factory=Action(method="GET", url="platform/api/v1/users/{id}/login"),
    )
...
class AgentsActions:
    list: Action = field(
        default_factory=Action(method="GET", url="api/v1/accounts/{account_id}/agents"),
    )
    create: Action = field(
        default_factory=Action(
            method="POST",
...
class ProfileActions:
    get: Action = field(
        default_factory=Action(
            method="GET",
            url="api/v1/accounts/{account_id}/profile",
        ),
    )
...
class TeamsActions:
    list: Action = field(
        default_factory=Action(method="GET", url="api/v1/accounts/{account_id}/teams"),
    )
    create: Action = field(
        default_factory=Action(
            method="POST",
